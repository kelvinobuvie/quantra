    ...
    <div className="lg:ml-56 px-4">
      ...
      {loading ? (
        ...
        <div>
          ...
          {/* Filter by Status */}
          <div className="mb-4">
            <label htmlFor="statusFilter" className="font-bold mr-2">Filter by Status:</label>
            <select
              id="statusFilter"
              value={statusFilter}
          ...
          <h3 className="text-lg font-bold mb-4">Safe Lock Transactions</h3>
              ...
              <tbody className="text-sm">
                {filteredSafelocks.map((safelock) => (
                  <tr key={safelock.id}>
                    ...
                    <td className="border-b py-4 px-1 text-blue-950">{safelock.createdAt}</td>
